...
const forgotPasswordTemplate = fs.readFileSync('emails/forgotPasswordEmail.ejs', 'utf8');
const deletedAccountTemplate = fs.readFileSync('emails/accountDeletedEmail.ejs', 'utf8');
...
export const renderDeletedAccountEmail = async (adminEmail) => {
    return await ejs.render(deletedAccountTemplate, { adminEmail });
};
